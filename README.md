...
This project includes a `CLAUDE.md` that gives Claude Code full context — architecture, all verified commands, MCP tool reference, and design notes. Claude Code reads it automatically on startup.
...
`CLAUDE.md` covers:
- Every npm script with its purpose
- The 5 MCP tools and their auth requirements
- Key files and what they do
- The token-cap architecture and the single write boundary
...
- [CLAUDE.md](./CLAUDE.md) — full command reference, architecture, and MCP tool table for Claude Code and contributors.
- [deploy/README.md](./deploy/README.md) — deploy runbook.
