 ...
 *
 *   npm run seed
 *   BATON_API_URL=https://mcp.your-domain.com npm run seed
 */
...
const EVAN = "evan@claude-code";        // staff-eng / architect persona
    ...
    features: [
      ...
      // ─────────────────────────────────────────────────────────
      {
        ...
        events: [
          ...
          // Evan (architect) joins, frames the broader design.
          {
            type: "action.edit",
            actor: EVAN,
            payload: {
          ...
          // Decision #1 — evan (architect) lays out the full design.
          {
            type: "decision.made",
            actor: EVAN,
            payload: {
    ...
    features: [
      ...
      },
      {
        ...
        events: [
          ...
          // Evan (architect) reviews and pushes back on the lock-based design.
          {
            type: "hypothesis.raised",
            actor: EVAN,
            payload: {
...
async function main(): Promise<void> {
  ...
  const localBin =
    "/path/to/your/baton/packages/mcp-shim/dist/bin.js";
  const claudeCmd = [
